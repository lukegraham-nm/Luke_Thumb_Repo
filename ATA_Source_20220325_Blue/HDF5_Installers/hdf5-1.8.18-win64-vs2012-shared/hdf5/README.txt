...
HDF5 1.8 that was compiled on;
    Windows 7 x64, using VISUAL STUDIO 2012.
...
The contents of this directory are:
    ...
    HDF5-1.8.18-win64.msi    - HDF5 Install Package

Installation
===========================================================================
1. Execute HDF5-1.8.18-win64.msi
2. Follow prompts
===========================================================================
...
To test the installation with the examples;
    ...
    The default installation folder is defined as "C:/Program Files/HDF_Group/HDF5/1.8.18".
